...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False):
        ...
        #block = (self.inplanes, planes, stride, self.groups,self.base_width, previous_dilation, norm_layer)
        layers = []
...
def _resnet(arch, block, layers, BasicBlock, **kwargs):
    model = ResNet(block, layers, **kwargs)
    
    return model    
        

def resnet50(Bottleneck , **kwargs):
   
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3],BasicBlock,
                   **kwargs)
